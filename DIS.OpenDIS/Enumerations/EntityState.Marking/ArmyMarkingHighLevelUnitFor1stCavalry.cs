...
namespace DIS.OpenDIS.Enumerations.EntityState.Marking
{
    /// <summary>
    /// Enumeration values for ArmyMarkingHighLevelUnitFor1stCavalry (es.markingtext.cctt.1cavunit, Byte 3 - High Level Unit (Byte 2 = 1 - 1st Cavalry), 
    /// section 4.5.1)
