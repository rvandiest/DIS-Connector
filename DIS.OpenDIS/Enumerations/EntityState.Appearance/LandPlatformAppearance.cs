...
namespace DIS.OpenDIS.Enumerations.EntityState.Appearance
{
    ...
    public struct LandPlatformAppearance
    {
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.LandPlatformAppearance"/> to <see cref="System.UInt32"/>.
        /// </summary>
        /// <param name="obj">The <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.LandPlatformAppearance"/> scheme instance.</param>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="System.UInt32"/> to <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.LandPlatformAppearance"/>.
        /// </summary>
        ...
        /// <summary>
        /// Creates the <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.LandPlatformAppearance"/> instance from the byte array.
        /// </summary>
        /// <param name="array">The array which holds the values for the <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.LandPlatformAppearance"/>.</param>
        /// <param name="index">The starting position within value.</param>
        /// <returns>The <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.LandPlatformAppearance"/> instance, represented by a byte array.</returns>
        ...
        /// <summary>
        /// Creates the <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.LandPlatformAppearance"/> instance from the uint value.
        /// </summary>
        /// <param name="value">The uint value which represents the <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.LandPlatformAppearance"/> instance.</param>
        /// <returns>The <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.LandPlatformAppearance"/> instance, represented by the uint value.</returns>
        ...
        /// <summary>
        /// Determines whether the specified <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.LandPlatformAppearance"/> instance is equal to this instance.
        /// </summary>
        /// <param name="other">The <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.LandPlatformAppearance"/> instance to compare with this instance.</param>
        /// <returns>
        /// 	<c>true</c> if the specified <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.LandPlatformAppearance"/> is equal to this instance; otherwise, <c>false</c>.
        /// </returns>
        ...
        /// <summary>
        /// Converts the instance of <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.LandPlatformAppearance"/> to the byte array.
        /// </summary>
        /// <returns>The byte array representing the current <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.LandPlatformAppearance"/> instance.</returns>
        ...
        /// <summary>
        /// Converts the instance of <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.LandPlatformAppearance"/> to the uint value.
        /// </summary>
        /// <returns>The uint value representing the current <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.LandPlatformAppearance"/> instance.</returns>
