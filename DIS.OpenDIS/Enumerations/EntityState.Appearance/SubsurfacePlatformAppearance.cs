...
namespace DIS.OpenDIS.Enumerations.EntityState.Appearance
{
    ...
    public struct SubsurfacePlatformAppearance
    {
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.SubsurfacePlatformAppearance"/> to <see cref="System.UInt32"/>.
        /// </summary>
        /// <param name="obj">The <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.SubsurfacePlatformAppearance"/> scheme instance.</param>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="System.UInt32"/> to <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.SubsurfacePlatformAppearance"/>.
        /// </summary>
        ...
        /// <summary>
        /// Creates the <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.SubsurfacePlatformAppearance"/> instance from the byte array.
        /// </summary>
        /// <param name="array">The array which holds the values for the <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.SubsurfacePlatformAppearance"/>.</param>
        /// <param name="index">The starting position within value.</param>
        /// <returns>The <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.SubsurfacePlatformAppearance"/> instance, represented by a byte array.</returns>
        ...
        /// <summary>
        /// Converts the instance of <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.SubsurfacePlatformAppearance"/> to the byte array.
        /// </summary>
        /// <returns>The byte array representing the current <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.SubsurfacePlatformAppearance"/> instance.</returns>
        ...
        /// <summary>
        /// Converts the instance of <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.SubsurfacePlatformAppearance"/> to the uint value.
        /// </summary>
        /// <returns>The uint value representing the current <see cref="DIS.OpenDIS.Enumerations.EntityState.Appearance.SubsurfacePlatformAppearance"/> instance.</returns>
