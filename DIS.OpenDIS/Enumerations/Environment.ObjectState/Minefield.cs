...
namespace DIS.OpenDIS.Enumerations.Environment.ObjectState
{
    ...
    public struct Minefield
    {
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="DIS.OpenDIS.Enumerations.Environment.ObjectState.Minefield"/> to <see cref="System.UInt32"/>.
        /// </summary>
        /// <param name="obj">The <see cref="DIS.OpenDIS.Enumerations.Environment.ObjectState.Minefield"/> scheme instance.</param>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="System.UInt32"/> to <see cref="DIS.OpenDIS.Enumerations.Environment.ObjectState.Minefield"/>.
        /// </summary>
        ...
        /// <summary>
        /// Creates the <see cref="DIS.OpenDIS.Enumerations.Environment.ObjectState.Minefield"/> instance from the byte array.
        /// </summary>
        /// <param name="array">The array which holds the values for the <see cref="DIS.OpenDIS.Enumerations.Environment.ObjectState.Minefield"/>.</param>
        /// <param name="index">The starting position within value.</param>
        /// <returns>The <see cref="DIS.OpenDIS.Enumerations.Environment.ObjectState.Minefield"/> instance, represented by a byte array.</returns>
        ...
        /// <summary>
        /// Converts the instance of <see cref="DIS.OpenDIS.Enumerations.Environment.ObjectState.Minefield"/> to the byte array.
        /// </summary>
        /// <returns>The byte array representing the current <see cref="DIS.OpenDIS.Enumerations.Environment.ObjectState.Minefield"/> instance.</returns>
        ...
        /// <summary>
        /// Converts the instance of <see cref="DIS.OpenDIS.Enumerations.Environment.ObjectState.Minefield"/> to the uint value.
        /// </summary>
        /// <returns>The uint value representing the current <see cref="DIS.OpenDIS.Enumerations.Environment.ObjectState.Minefield"/> instance.</returns>
