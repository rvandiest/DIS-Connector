...
namespace DIS.OpenDIS.Enumerations.EntityState.Type
{
    /// <summary>
    /// Enumeration values for CISWeaponsForLifeFormsSubcategory (es.type.222.kind.3.subcat, C.I.S. Weapons for Life Forms Subcategory, 
    /// section 4.2.3.3.2)
