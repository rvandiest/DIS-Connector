...
namespace Enumerations.EntityState.Appearance
{
    ...
    public struct EnvironmentalAppearance
    {
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="Enumerations.EntityState.Appearance.EnvironmentalAppearance"/> to <see cref="System.UInt32"/>.
        /// </summary>
        /// <param name="obj">The <see cref="Enumerations.EntityState.Appearance.EnvironmentalAppearance"/> scheme instance.</param>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="System.UInt32"/> to <see cref="Enumerations.EntityState.Appearance.EnvironmentalAppearance"/>.
        /// </summary>
        ...
        /// <summary>
        /// Creates the <see cref="Enumerations.EntityState.Appearance.EnvironmentalAppearance"/> instance from the byte array.
        /// </summary>
        /// <param name="array">The array which holds the values for the <see cref="Enumerations.EntityState.Appearance.EnvironmentalAppearance"/>.</param>
        /// <param name="index">The starting position within value.</param>
        /// <returns>The <see cref="Enumerations.EntityState.Appearance.EnvironmentalAppearance"/> instance, represented by a byte array.</returns>
        ...
        /// <summary>
        /// Creates the <see cref="Enumerations.EntityState.Appearance.EnvironmentalAppearance"/> instance from the uint value.
        /// </summary>
        /// <param name="value">The uint value which represents the <see cref="Enumerations.EntityState.Appearance.EnvironmentalAppearance"/> instance.</param>
        /// <returns>The <see cref="Enumerations.EntityState.Appearance.EnvironmentalAppearance"/> instance, represented by the uint value.</returns>
        ...
        /// <summary>
        /// Determines whether the specified <see cref="Enumerations.EntityState.Appearance.EnvironmentalAppearance"/> instance is equal to this instance.
        /// </summary>
        /// <param name="other">The <see cref="Enumerations.EntityState.Appearance.EnvironmentalAppearance"/> instance to compare with this instance.</param>
        /// <returns>
        /// 	<c>true</c> if the specified <see cref="Enumerations.EntityState.Appearance.EnvironmentalAppearance"/> is equal to this instance; otherwise, <c>false</c>.
        /// </returns>
        ...
        /// <summary>
        /// Converts the instance of <see cref="Enumerations.EntityState.Appearance.EnvironmentalAppearance"/> to the byte array.
        /// </summary>
        /// <returns>The byte array representing the current <see cref="Enumerations.EntityState.Appearance.EnvironmentalAppearance"/> instance.</returns>
        ...
        /// <summary>
        /// Converts the instance of <see cref="Enumerations.EntityState.Appearance.EnvironmentalAppearance"/> to the uint value.
        /// </summary>
        /// <returns>The uint value representing the current <see cref="Enumerations.EntityState.Appearance.EnvironmentalAppearance"/> instance.</returns>
