...
namespace DIS.Enumerations.EntityState.Appearance
{
    ...
    public struct SensorEmitterAppearance
    {
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="DIS.Enumerations.EntityState.Appearance.SensorEmitterAppearance"/> to <see cref="System.UInt32"/>.
        /// </summary>
        /// <param name="obj">The <see cref="DIS.Enumerations.EntityState.Appearance.SensorEmitterAppearance"/> scheme instance.</param>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="System.UInt32"/> to <see cref="DIS.Enumerations.EntityState.Appearance.SensorEmitterAppearance"/>.
        /// </summary>
        ...
        /// <summary>
        /// Creates the <see cref="DIS.Enumerations.EntityState.Appearance.SensorEmitterAppearance"/> instance from the byte array.
        /// </summary>
        /// <param name="array">The array which holds the values for the <see cref="DIS.Enumerations.EntityState.Appearance.SensorEmitterAppearance"/>.</param>
        /// <param name="index">The starting position within value.</param>
        /// <returns>The <see cref="DIS.Enumerations.EntityState.Appearance.SensorEmitterAppearance"/> instance, represented by a byte array.</returns>
        ...
        /// <summary>
        /// Creates the <see cref="DIS.Enumerations.EntityState.Appearance.SensorEmitterAppearance"/> instance from the uint value.
        /// </summary>
        /// <param name="value">The uint value which represents the <see cref="DIS.Enumerations.EntityState.Appearance.SensorEmitterAppearance"/> instance.</param>
        /// <returns>The <see cref="DIS.Enumerations.EntityState.Appearance.SensorEmitterAppearance"/> instance, represented by the uint value.</returns>
        ...
        /// <summary>
        /// Determines whether the specified <see cref="DIS.Enumerations.EntityState.Appearance.SensorEmitterAppearance"/> instance is equal to this instance.
        /// </summary>
        /// <param name="other">The <see cref="DIS.Enumerations.EntityState.Appearance.SensorEmitterAppearance"/> instance to compare with this instance.</param>
        /// <returns>
        /// 	<c>true</c> if the specified <see cref="DIS.Enumerations.EntityState.Appearance.SensorEmitterAppearance"/> is equal to this instance; otherwise, <c>false</c>.
        /// </returns>
        ...
        /// <summary>
        /// Converts the instance of <see cref="DIS.Enumerations.EntityState.Appearance.SensorEmitterAppearance"/> to the byte array.
        /// </summary>
        /// <returns>The byte array representing the current <see cref="DIS.Enumerations.EntityState.Appearance.SensorEmitterAppearance"/> instance.</returns>
        ...
        /// <summary>
        /// Converts the instance of <see cref="DIS.Enumerations.EntityState.Appearance.SensorEmitterAppearance"/> to the uint value.
        /// </summary>
        /// <returns>The uint value representing the current <see cref="DIS.Enumerations.EntityState.Appearance.SensorEmitterAppearance"/> instance.</returns>
