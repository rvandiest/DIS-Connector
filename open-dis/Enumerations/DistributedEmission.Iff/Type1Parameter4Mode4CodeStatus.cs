...
namespace DIS.Enumerations.DistributedEmission.Iff
{
    ...
    public struct Type1Parameter4Mode4CodeStatus
    {
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="DIS.Enumerations.DistributedEmission.Iff.Type1Parameter4Mode4CodeStatus"/> to <see cref="System.UInt16"/>.
        /// </summary>
        /// <param name="obj">The <see cref="DIS.Enumerations.DistributedEmission.Iff.Type1Parameter4Mode4CodeStatus"/> scheme instance.</param>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="System.UInt16"/> to <see cref="DIS.Enumerations.DistributedEmission.Iff.Type1Parameter4Mode4CodeStatus"/>.
        /// </summary>
        ...
        /// <summary>
        /// Creates the <see cref="DIS.Enumerations.DistributedEmission.Iff.Type1Parameter4Mode4CodeStatus"/> instance from the byte array.
        /// </summary>
        /// <param name="array">The array which holds the values for the <see cref="DIS.Enumerations.DistributedEmission.Iff.Type1Parameter4Mode4CodeStatus"/>.</param>
        /// <param name="index">The starting position within value.</param>
        /// <returns>The <see cref="DIS.Enumerations.DistributedEmission.Iff.Type1Parameter4Mode4CodeStatus"/> instance, represented by a byte array.</returns>
        ...
        /// <summary>
        /// Creates the <see cref="DIS.Enumerations.DistributedEmission.Iff.Type1Parameter4Mode4CodeStatus"/> instance from the ushort value.
        /// </summary>
        /// <param name="value">The ushort value which represents the <see cref="DIS.Enumerations.DistributedEmission.Iff.Type1Parameter4Mode4CodeStatus"/> instance.</param>
        /// <returns>The <see cref="DIS.Enumerations.DistributedEmission.Iff.Type1Parameter4Mode4CodeStatus"/> instance, represented by the ushort value.</returns>
        ...
        /// <summary>
        /// Determines whether the specified <see cref="DIS.Enumerations.DistributedEmission.Iff.Type1Parameter4Mode4CodeStatus"/> instance is equal to this instance.
        /// </summary>
        /// <param name="other">The <see cref="DIS.Enumerations.DistributedEmission.Iff.Type1Parameter4Mode4CodeStatus"/> instance to compare with this instance.</param>
        /// <returns>
        /// 	<c>true</c> if the specified <see cref="DIS.Enumerations.DistributedEmission.Iff.Type1Parameter4Mode4CodeStatus"/> is equal to this instance; otherwise, <c>false</c>.
        /// </returns>
        ...
        /// <summary>
        /// Converts the instance of <see cref="DIS.Enumerations.DistributedEmission.Iff.Type1Parameter4Mode4CodeStatus"/> to the byte array.
        /// </summary>
        /// <returns>The byte array representing the current <see cref="DIS.Enumerations.DistributedEmission.Iff.Type1Parameter4Mode4CodeStatus"/> instance.</returns>
        ...
        /// <summary>
        /// Converts the instance of <see cref="DIS.Enumerations.DistributedEmission.Iff.Type1Parameter4Mode4CodeStatus"/> to the ushort value.
        /// </summary>
        /// <returns>The ushort value representing the current <see cref="DIS.Enumerations.DistributedEmission.Iff.Type1Parameter4Mode4CodeStatus"/> instance.</returns>
