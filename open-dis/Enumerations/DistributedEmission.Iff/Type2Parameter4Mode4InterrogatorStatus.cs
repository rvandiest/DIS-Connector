...
namespace Enumerations.DistributedEmission.Iff
{
    ...
    public struct Type2Parameter4Mode4InterrogatorStatus
    {
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="Enumerations.DistributedEmission.Iff.Type2Parameter4Mode4InterrogatorStatus"/> to <see cref="System.UInt16"/>.
        /// </summary>
        /// <param name="obj">The <see cref="Enumerations.DistributedEmission.Iff.Type2Parameter4Mode4InterrogatorStatus"/> scheme instance.</param>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="System.UInt16"/> to <see cref="Enumerations.DistributedEmission.Iff.Type2Parameter4Mode4InterrogatorStatus"/>.
        /// </summary>
        ...
        /// <summary>
        /// Creates the <see cref="Enumerations.DistributedEmission.Iff.Type2Parameter4Mode4InterrogatorStatus"/> instance from the byte array.
        /// </summary>
        /// <param name="array">The array which holds the values for the <see cref="Enumerations.DistributedEmission.Iff.Type2Parameter4Mode4InterrogatorStatus"/>.</param>
        /// <param name="index">The starting position within value.</param>
        /// <returns>The <see cref="Enumerations.DistributedEmission.Iff.Type2Parameter4Mode4InterrogatorStatus"/> instance, represented by a byte array.</returns>
        ...
        /// <summary>
        /// Creates the <see cref="Enumerations.DistributedEmission.Iff.Type2Parameter4Mode4InterrogatorStatus"/> instance from the ushort value.
        /// </summary>
        /// <param name="value">The ushort value which represents the <see cref="Enumerations.DistributedEmission.Iff.Type2Parameter4Mode4InterrogatorStatus"/> instance.</param>
        /// <returns>The <see cref="Enumerations.DistributedEmission.Iff.Type2Parameter4Mode4InterrogatorStatus"/> instance, represented by the ushort value.</returns>
        ...
        /// <summary>
        /// Determines whether the specified <see cref="Enumerations.DistributedEmission.Iff.Type2Parameter4Mode4InterrogatorStatus"/> instance is equal to this instance.
        /// </summary>
        /// <param name="other">The <see cref="Enumerations.DistributedEmission.Iff.Type2Parameter4Mode4InterrogatorStatus"/> instance to compare with this instance.</param>
        /// <returns>
        /// 	<c>true</c> if the specified <see cref="Enumerations.DistributedEmission.Iff.Type2Parameter4Mode4InterrogatorStatus"/> is equal to this instance; otherwise, <c>false</c>.
        /// </returns>
        ...
        /// <summary>
        /// Converts the instance of <see cref="Enumerations.DistributedEmission.Iff.Type2Parameter4Mode4InterrogatorStatus"/> to the byte array.
        /// </summary>
        /// <returns>The byte array representing the current <see cref="Enumerations.DistributedEmission.Iff.Type2Parameter4Mode4InterrogatorStatus"/> instance.</returns>
        ...
        /// <summary>
        /// Converts the instance of <see cref="Enumerations.DistributedEmission.Iff.Type2Parameter4Mode4InterrogatorStatus"/> to the ushort value.
        /// </summary>
        /// <returns>The ushort value representing the current <see cref="Enumerations.DistributedEmission.Iff.Type2Parameter4Mode4InterrogatorStatus"/> instance.</returns>
